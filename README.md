...
The necessary [ROS](https://docs.ros.org/en/humble/Releases.html) software for installation on the Raspberry Pi Zero can be found [here](https://github.com/107-systems/l3xz-sw-pan-tilt-head).
